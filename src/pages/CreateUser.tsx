...
const CreateUser = () => {
  const { setCreateUserModal, setInfo } = useGlobalContext()
  ...
  return (
    <form className="flex flex-col" onSubmit={onCreateUser}>
      <p className="font-bold text-center mb-6">Crear Usuario</p>
      ...
      <div className="flex justify-end mt-3 gap-3 text-sm">
        <button className="bg-black text-white px-8 py-0.5" type="submit">
          Guardar
        </button>
        <button
          className="bg-black text-white px-8 py-0.5"
